...
export const AdminOpportunities: React.FC = () => {
    const { properties, clients, updateManagerDispatch, markAsSold, deletePropertiesBulk, isManager, updateStatus } = useApp();
    ...
    {/* Expired Auction Check */ }
    {
        prop.auctionDate && prop.auctionDate < new Date().toISOString().split('T')[0] && (
            <button
                ...
                className="inline-flex items-center gap-1 px-3 py-1 bg-gray-600 text-white text-xs font-bold rounded hover:bg-gray-700 shadow-sm"
