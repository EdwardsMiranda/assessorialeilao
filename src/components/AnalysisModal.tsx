...
import { X, AlertTriangle, CheckCircle, BrainCircuit, ExternalLink, Calendar, Upload, Link as LinkIcon, FileText, Scale, MapPin, Search, Calculator, Plus, Trash2, DollarSign, TrendingUp, CalendarDays, ChevronDown, ChevronUp, Eye, Percent, ArrowRight, Gavel, Edit, Sparkles, ImagePlus, FileSearch, RefreshCw, Check, XCircle, Save } from 'lucide-react';
...
export const AnalysisModal: React.FC<AnalysisModalProps> = ({ property, onClose }) => {
  ...
  const isAssignedToMe = property.assignedTo === currentUser.id;
      ...
      reader.onloadend = async () => {
        ...
        if (result) {
          setFormData(prev => ({
            ...
            cpfPropterRem: result.propterRem || prev.propterRem,
          }));
